...
%======================================================================
\begin{spacing}{1.4}
	{\large Master \textbf{Fahrzeugbau: Werkstoffe und Komponenten} mit guten Grundlagen in Physik, Mathematik und Materialwissenschaften. Gute Kenntnisse in Strukturmodellierung, Analyse und Modalanalyse, gute Begeisterung von Computer- und Netzwerktechnologien, gute Kenntnisse in der Verwendung von Linux, SSH, Git und anderen gängigen Plattformen und Tools. Sehr gute Kenntnisse in wissenschaftlicher Computersoftware, \Matlab- und \Mathematica-Programmierung, Erfahrung in FEM-Software wie \Ansys.}
\end{spacing}
...
\begin{itemize}
	...
	\item 
	\link{https://github.com/sq43793911/Masterarbeit_public}{\texttt{\textbf{\underline{{\large Masterarbeit:}}}}} (\textit{Matlab\textregistered}, \textit{Mathematica\textregistered}, \textit{Ansys\textregistered}, \textit{Solidworks\textregistered}, \textit{\LaTeX})\\[1mm]
	...
	\item \link{https://github.com/sq43793911/Projektarbeit_public}{\texttt{\textbf{\underline{{\large Projektarbeit:}}}}} (\textit{\Matlab, \Mathematica, \Ansys, \LaTeX})\\[1mm]
	  ...
	  \item \link{https://github.com/sq43793911/Intelligent-Algorithms}{\texttt{\textbf{\underline{{\large Forschungsprojekt für intelligente Algorithmen:}}}}}(\Matlab)\\[1mm]
  	...
  	\item \link{https://github.com/sq43793911/Balance_Car}{\texttt{\textbf{\underline{{\large Zweirad-Selbstbalance-Fahrzeug:}}}}}(Freescale\textregistered CodeWarrior, Freescale\textregistered S12X, C, CCD) \\[1mm]
...
\vspace{-5mm}
  	\item \link{https://github.com/sq43793911/Construction_Analysis}{\texttt{\textbf{\underline{{\large Analysieren elastischer Schwingungssysteme:}}}}}(\Matlab)\\[1mm]
	...
	\item \link{https://github.com/sq43793911/resume}{\texttt{\textbf{\underline{{\large Lebenslauf:}}}}}(\LaTeX)\\[1mm]
