...
\begin{competences}[10em]
  ...
  \comptence{{\large Fachgebiet}}{
   {\large  \textbf{E-Auto}, \quad \textbf{Leichtbau}, \quad \textbf{Modalanalyse}, \quad Werkstofftechnik und Strukturanalyse, MCU-System}
  }
...
{\large   	\textbf{Deutsch} --- gut; \quad
    \textbf{English} --- genügend}
  }
\end{competences}
\end{spacing}
...
\begin{itemize}
	...
	\item \link{https://github.com/sq43793911/Projektarbeit_public}{\texttt{\textbf{\underline{{\large \faGithub Projektarbeit:}}}}} (\textit{\Matlab, \Mathematica, \Ansys, \LaTeX})\\[1mm]
		{\large \textbf{Modalanalyse mit Hilfe der Finite-Elemente-Methode.} Im Rahmen der ausgeschriebenen Arbeit ist ein Programm zur numerischen Modalanalyse mittels der Finite-Elemente-Methode zu entwickeln.}

	  \item \link{https://github.com/sq43793911/Intelligent-Algorithms}{\texttt{\textbf{\underline{{\large \faGithub Forschungsprojekt für intelligente Algorithmen:}}}}}(\Matlab)\\[1mm]
  	...
  	\item \link{https://github.com/sq43793911/Balance_Car}{\texttt{\textbf{\underline{{\large \faGithub Zweirad-Selbstbalance-Fahrzeug:}}}}}(Freescale\textregistered CodeWarrior, Freescale\textregistered S12X, C, CCD) \\[1mm]
...
\vspace{-5mm}
  	\item \link{https://github.com/sq43793911/Construction_Analysis}{\texttt{\textbf{\underline{{\large \faGithub Analysieren der Schwingungssysteme:}}}}}(\Matlab)\\[1mm]
	...
	\item \link{https://github.com/sq43793911/resume}{\texttt{\textbf{\underline{{\large \faGithub Lebenslauf:}}}}}(\LaTeX)\\[1mm]
